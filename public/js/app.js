      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            ...
            Swal.close();
            Swal.fire("Eliminado", "El valor de la propina ha sido eliminada satisfactoriamente", "success").then(function () {
  ...
  $(".btnEditTips").on("click", function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $("#formUpdateTips").attr("action", "/administrator/tips/" + data.id);
...
//require('./bootstrap');
__webpack_require__(/*! ./users.js */ "./resources/js/users.js");

__webpack_require__(/*! ./commercers.js */ "./resources/js/commercers.js");

__webpack_require__(/*! ./categories.js */ "./resources/js/categories.js");

__webpack_require__(/*! ./customers.js */ "./resources/js/customers.js");

__webpack_require__(/*! ./distributors */ "./resources/js/distributors.js");

__webpack_require__(/*! ./commerceCategory.js */ "./resources/js/commerceCategory.js");

__webpack_require__(/*! ./categoryfromCommerces.js */ "./resources/js/categoryfromCommerces.js");

__webpack_require__(/*! ./units */ "./resources/js/units.js");

__webpack_require__(/*! ./slider.js */ "./resources/js/slider.js");

__webpack_require__(/*! ./permits */ "./resources/js/permits.js");

__webpack_require__(/*! ./restaurant */ "./resources/js/restaurant.js");

__webpack_require__(/*! ./Tips.js */ "./resources/js/Tips.js");

__webpack_require__(/*! ./market.js */ "./resources/js/market.js");

__webpack_require__(/*! ./delivery_hours */ "./resources/js/delivery_hours.js");

__webpack_require__(/*! ./order */ "./resources/js/order.js");

__webpack_require__(/*! ./minShopping */ "./resources/js/minShopping.js");

__webpack_require__(/*! ./coupons */ "./resources/js/coupons.js");
...
$(document).ready(function () {
  ...
  $('.updateBtn').click(function (e) {
    ...
    fetch('categories/' + id, {
      ...
      return response.ok ? response.json() : alert("error");
    }).then(function (data) {
      var cat = data.data;
      console.log(cat);
      $('#order').val(cat.order);
      ...
      $(".imgView").attr("src", $('#idCat').attr('data-imgRoute') + '/' + cat.img_category);
      $('#editCategory').modal('show');
    })["catch"](function (error) {
      return alert("Error de red" + error);
    });
  });
  ...
  $('.selectCommerce').on('change', function () {
    var id = $(this).val();
    var radio = $('.radioCategoryTypes:checked').val();
    $.ajax({
      type: "get",
      ...
      success: function success(response) {
        ...
        var data = response.data;
        data.map(function (c) {
          $('.categoriesList').append("\n                        <div class=\"col-6\">\n                            <div class=\"custom-control custom-radio\">\n                                <input type=\"radio\" id=\"cat_".concat(c.id, "\" ").concat(radio == 'cat1' ? 'disabled' : '', " name=\"parent_id\" value=\"").concat(c.id, "\" class=\"custom-control-input categoryRadios\">\n                                <label class=\"custom-control-label\" for=\"cat_").concat(c.id, "\">").concat(c.name, "</label>\n                            </div>\n                        </div>\n                        "));
        });
        Swal.close();
      },
...
/***/ "./resources/js/categoryfromCommerces.js":
/*!***********************************************!*\
  !*** ./resources/js/categoryfromCommerces.js ***!
  \***********************************************/
/*! no static exports found */
...
$(document).ready(function () {
  $('.btnDeleteforCategories').on('click', function (e) {
    var category_id = $(this).parents('tr').attr('id');
    var commerce = $('#idcommercio').val();
    Swal.fire({
      title: '¿Esta seguro?',
      text: "Esta Categoria será eliminado permanentemente",
      icon: 'warning',
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'La cetegoria ha sido borrado satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          }
        });
...
/***/ "./resources/js/commerceCategory.js":
/*!******************************************!*\
  !*** ./resources/js/commerceCategory.js ***!
  \******************************************/
/*! no static exports found */
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.close();
            Swal.fire('Eliminado', 'La categoria ha sido borrado satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          },
          error: function error() {
...
$(document).ready(function () {
  ...
  $('.selectCommerceType').on('change', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        var data = response.data;
        data.map(function (c) {
          $('.categoriesList').append("\n                        <div class=\"col\">\n                            <div class=\"custom-control custom-checkbox\">\n                                <input type=\"checkbox\" name=\"categories[]\" value=\"".concat(c.id, "\" class=\"custom-control-input\" id=\"cat_").concat(c.id, "\">\n                                <label class=\"custom-control-label\" for=\"cat_").concat(c.id, "\">").concat(c.name, "</label>\n                            </div>\n                        </div>\n                        \n                        "));
        });
        Swal.close();
      },
      error: function error() {
  ...
  $('.btnUpdatecommerce').on('click', function (e) {
    ...
    if ($('#newAddressLat').val().length == 0 || $('#newAddressLong').val().length == 0) {
      Swal.fire('', 'Por favor seleccione la dirección correctamente', 'warning');
    } else {
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.close();
            Swal.fire("Eliminado", "El cupon ha sido eliminado satisfactoriamente", "success").then(function () {
              window.location.reload();
            });
          }
        });
  ...
  $(".btnEditCoupons").on("click", function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        console.log(response);
        var data = response.data;
        $("#formUpdateCoupon").attr("action", "/administrator/coupons/" + data.id);
        $('.commerce_id').val(data.commerce_id);
        $("#commerce_id option[value=" + data.commerce_id + "]").attr("selected", true);
...
/***/ "./resources/js/delivery_hours.js":
/*!****************************************!*\
  !*** ./resources/js/delivery_hours.js ***!
  \****************************************/
/*! no static exports found */
...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (response.code == 200) {
          ...
          $('#limite_cupo_pd').val(response.data.limit_pd == -1 ? '' : response.data.limit_pd);
        ...
        $.ajax({
          ...
          success: function success(response) {
            ...
            if (response.code == 200) {
              $('.horarios').empty();
              $('.horarios').append(response.data);
              Swal.fire('Eliminado', 'Horario eliminado satisfactoriamente', 'success');
            }
          },
  ...
  $('#formEditHora').on('submit', function (e) {
    ...
    var weekday = $('.btnWeekDay.active').val();
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'El usuario ha sido borrado satisfactoriamente', 'success');
            window.location.reload();
          }
        });
      }
...
$(document).ready(function () {
  ...
  $('.btnEditVariation').on('click', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        var data = response.data;
        var priceList = data.get_product.get_values;
        console.log(data);
  ...
  $('#formUpdateMin').on('submit', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        Swal.close();
        Swal.fire('', 'Minimos actualizados completamente', 'success');
      },
      error: function error() {
        Swal.fire('Error', 'Hemos tenido problemas. Intente mas tarde', 'error');
      }
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'El Rol ha sido eliminada satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          }
        });
...
$(document).ready(function () {
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'La categoria ha sido eliminada satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          }
        });
  ...
  $('.btnAddIngredient').on('click', function () {
    ...
    var value = $('#newIngredientValue').val();
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (response.code == 200) {
          $('.bodyDetailCategories').append("\n                        <tr id=\"".concat(data.id, "\">\n                            <td>").concat(data.name, "</td>\n                            <td>").concat(data.value == null ? 'Sin precio' : data.value, "</td>\n                            <td>\n                                <button class=\"btn btn-warning btn-sm btnEditIngredient\"><i class=\"fas fa-pencil-alt\"></i></button>\n                                <button class=\"btn btn-danger btn-sm btnEraseIngredient\"><i class=\"fas fa-trash-alt\"></i></button>\n                            </td>\n                        </tr>\n                        "));
  ...
  $('#formUpdateIngredient').on('submit', function (e) {
    ...
    var value = $('#updateIngredientPrice').val();
    e.preventDefault();
    $.ajax({
      type: "put",
      url: url,
      ...
      success: function success(response) {
        if (response.code == 200) {
          ...
          $.ajax({
            type: "get",
            url: "/administrator/ingredients/byCategory/" + _id,
            dataType: "json",
            success: function success(response) {
              var data = response.data;
              console.log(data);
              data.map(function (i) {
                $('.bodyDetailCategories').append("\n                                    <tr id=\"".concat(i.id, "\">\n                                        <td id=\"name_").concat(i.id, "\">").concat(i.name, "</td>\n                                        <td id=\"price_").concat(i.id, "\">").concat(i.value == null ? 'Sin precio' : i.value, "</td>\n                                        <td>\n                                            <button class=\"btn btn-warning btn-sm btnEditIngredient\"><i class=\"fas fa-pencil-alt\"></i></button>\n                                            <button class=\"btn btn-danger btn-sm btnEraseIngredient\"><i class=\"fas fa-trash-alt\"></i></button>\n                                        </td>\n                                    </tr>\n                                    "));
              });
              $('#modalDetailCategory').modal();
            }
          });
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            ...
            if (response.code == 200) {
              Swal.fire('Eliminado', 'El ingrediente ha sido eliminado satisfactoriamente', 'success').then(function () {
                $('#modalDetailCategory').modal('hide');
                $('.bodyDetailCategories').empty();
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'El slider ha sido borrado satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          }
        });
...
$(document).ready(function () {
  $('.btnDeleteSliderG').on('click', function (e) {
    var id = $(this).parents('tr').attr('id');
    console.log(id);
    Swal.fire({
      title: '¿Esta seguro?',
      ...
      if (result.value) {
        $.ajax({
          type: "DELETE",
          url: "/administrator/gslider/delete",
          data: {
            id: id
          },
          dataType: "json",
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire("Eliminado", "La unidad ha sido eliminada satisfactoriamente", "success").then(function () {
              window.location.reload();
            });
          }
        });
  ...
  $(".btnEditUnit").on("click", function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        console.log(response);
        var data = response.data;
        $("#formUpdateUnit").attr("action", "/administrator/units/" + data.id);
        document.querySelectorAll(".optionCommerce").forEach(function(el) {
        el.setAttribute("disabled", "")
        el.style.color = "#ccc"
        });
        $("#commerce_id option[value=" + data.commerce_id + "]").attr("selected", true).attr("disabled", false).css("color", "black");;
        $("#unit").val(data.name);
        $("#state option[value=" + data.state + "]").attr("selected", true);
        $("#modalEditUnit").modal();
      }
    ...
    Swal.fire({
      ...
      if (result.value) {
        $.ajax({
          ...
          success: function success(response) {
            console.log(response);
            Swal.fire('Eliminado', 'Direccion elimanda satisfactoriamente', 'success').then(function () {
              window.location.reload();
            });
          }
        });
...
__webpack_require__(/*! C:\wamp64\www\favoresMarketplace\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\wamp64\www\favoresMarketplace\resources\sass\app.scss */"./resources/sass/app.scss");
