                ...
                <div class="col-lg-5 col-md-7 text-center">
                    <div class="card bg-secondary border-0 mb-0" style="width: 30vw;">
                        <div class="card-body">
                            ...
                            <small>Escribe el código de confirmación que enviamos a tu teléfono</small>
                            <form role="form" action="{{route('auth.confirmCode.validate')}}" method="POST" autocomplete="off">
                                @csrf
                                <div class="form-group mt-4">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input class="form-control" name="code" placeholder="Código" type="text">
                                    </div>
                                </div>
                                <div class="text-left">
                                    @if($errors->any())
                                    <p class="m-0 text-danger">El código no coincide</p>
                                    @endif
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-info my-2">Enviar</button>
                                </div>
                                <!-- <a class="text-left" href=""><small>Reenviar código</small></a> -->
                            </form>
                        </div>
                    </div>
                </div>
