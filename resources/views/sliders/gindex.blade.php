    ...
    <div class="row mt-5">
        <div class="col-4">
            <div class="card shadow bg-secondary">
                ...
                <div class="card-body">
                    <form action="{{ route('gslider.store') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        
                        <div class="form-group">
                            <label>Nombre *</label>
                            <input type="text" class="form-control" value = "{{old('name')}}" name="name" id="name" placeholder="Ingrese nombre del slider">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input style="font-size: .8rem;" type="url" name="redirect_url" value = "{{old('redirect_url')}}"  class="form-control" placeholder="Debe tener la forma: http://ejemplo.com">
                        </div>
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">Sliders globales: </h3>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr id="{{$item['id']}}">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" href="{{route('gslider.edit', [$item['id']])}}"><i class="fas fa-edit"></i>editar</a>
                                    <button class="btn btn-sm btn-danger btnDeleteSliderG"><i class="fas fa-trash-alt"></i></button>
                                </td>
                            </tr>
                            @endif
                            @endforeach
