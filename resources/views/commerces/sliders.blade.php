                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('sliders.view', [$commerce->id])}}">Sliders</a></li>
                ...
                <div class="card-body">
                    <form action="{{ route('sliders.store') }}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            <label>Nombre *</label>
                            <input type="text" class="form-control" name="name" id="name" placeholder="Ingrese nombre del slider">
                        </div>
                        <div class="form-group">
                            <label>Imagen *<small style="font-size: .7rem">Tamaño recomendado: 208 alto x  370 ancho</small></label>
                            <input type="file" name="url" class="form-control" lang="en">
                        </div>
                        <div class="form-group">
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr id="{{$item->id}}">
                                ...
                                <td>
                                    <a class="btn btn-sm btn-warning" href="{{route('sliders.edit', [$item->id])}}"><i class="fas fa-edit"></i>editar</a>
