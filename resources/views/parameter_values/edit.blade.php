        ...
        <form method="post" action="{{route('ParameterValue.update',[$data->id])}}" autocomplete="off">
          ...
          <div class="pl-lg-4">
            <div class="row">
              ...
              <div class="form-group col">
                <label class="form-control-label" for="input-email">Extra *</label>
                <input type="number" name="nit" value="{{$data->nit}}" class="form-control form-control-alternative" placeholder="NIT" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col">
