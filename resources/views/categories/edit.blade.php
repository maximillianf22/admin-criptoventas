    ...
    <form action="{{ route('categories.update', [$category->id]) }}" enctype="multipart/form-data" method="post">
        ...
        <div class="row mt-5">
            <div class="col-5">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <img class="profile-user-img img-fluid mx-auto d-block imgUpdate" src="https://scotturb.com/wp-content/uploads/2016/11/product-placeholder.jpg" alt="User profile picture">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <label class="mt-0 mb-0">Tipo de categoría</label><br>
                        <small>Subcategoría require una categoría padre</small>
                        <div class="form-group mb-0">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" value="cat1" id="cat1" name="radioCategoryType" {{is_null($category->parent) ? 'checked' : ''}} class="custom-control-input radioCategoryTypes">
                                <label class="custom-control-label" for="cat1">Categoría principal</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" value="cat2" id="cat2" name="radioCategoryType" {{!is_null($category->parent) ? 'checked' : ''}} class="custom-control-input radioCategoryTypes">
                        ...
                        <div class="row mt-2 categoriesList">
                            ...
                            <div class="col-6">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="cat_{{$cat->id}}" {{is_null($category->parent) ? 'disabled' : ''}} {{$category->parent == $cat->id ? 'checked' : ''}} name="parent_id" value="{{$cat->id}}" class="custom-control-input categoryRadios">
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">Editar categoría de producto</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label>Nombre *</label>
                                    <input type="text" name="name" id="input-name" class="form-control" value="{{$category->name}}" placeholder="Nombre de la categoría" required>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <select name="commerce_id" class="form-control selectCommerce" required>
                                        ...
                                        <option value="{{$commerce->id}}" {{$category->commerce_id == $commerce->id ? 'selected' : ''}}>{{$commerce->bussiness_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" required placeholder="Descripción" id="exampleFormControlTextarea1" rows="3">{{$category->description}}</textarea>
                        </div>
                        <button type="submit" class="btn btn-info btn-block"> <i class="fat-add"></i> Actualizar</button>
                    </div>
                </div>
            </div>
        </div>
